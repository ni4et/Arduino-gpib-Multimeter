...
#define BASE_DEC 10 ///< Print value in decimal format (base 10)
#define BASE_HEX 16 ///< Print value in hexadecimal format (base 16)
#define BASE_OCT 8  ///< Print value in octal format (base 8)
#define BASE_BIN 2  ///< Print value in binary format (base 2)
#define BASE_BYTE 0 ///< Issue 7-segment data as raw bits
...
public:
  ...
  */
  ...
  /*!
    ...
    @param  base  Number base (default = BASE_BYTE = raw bits)
  */
  void print(char c, int base = BASE_BYTE);
  ...
  /*!
    ...
    @param  base  Number base (default = BASE_BYTE = raw bits)
  */
  void print(unsigned char b, int base = BASE_BYTE);
  ...
  */
  ...
  /*!
    ...
    @param  base  Number base (default = BASE_BYTE = raw bits)
  */
  void println(char c, int base = BASE_BYTE);
  ...
  /*!
    ...
    @param  base  Number base (default = BASE_BYTE = raw bits)
  */
  void println(unsigned char b, int base = BASE_BYTE);
